          ...
          <View style={styles.pickerInput}>
            ...
            <View style={{ marginLeft: 3, width: wp("75%") }}>
              ...
              >
                ...
                <Picker.Item label="A+" value="A+" color="black"></Picker.Item>
                <Picker.Item label="O+" value="O+" color="black"></Picker.Item>
                <Picker.Item label="B+" value="B+" color="black"></Picker.Item>
                <Picker.Item
                  label="AB+"
                  value="AB+"
                  color="black"
